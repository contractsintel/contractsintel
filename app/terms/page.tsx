  ...
  return (
    <div className="min-h-screen bg-[#080a0f] text-[#e8edf8]">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-serif mb-2">Terms of Service</h1>
        ...
        <div className="space-y-8 text-[15px] text-[#8b9ab5] leading-relaxed">
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Service Description</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Not Legal or Financial Advice</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Data Accuracy</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Subscriptions and Billing</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">AI-Generated Content</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Service Availability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Termination</h2>
            <p>We reserve the right to suspend or terminate your account if you violate these terms. You may terminate your account at any time by cancelling your subscription and emailing <a href="mailto:support@contractsintel.com" className="text-[#3b82f6]">support@contractsintel.com</a>.</p>
          </section>

          <section>
            <h2 className="text-lg font-semibold text-[#e8edf8] mb-3">Changes to Terms</h2>
          ...
          <section>
            ...
            <p>For questions about these terms, contact us at <a href="mailto:support@contractsintel.com" className="text-[#3b82f6]">support@contractsintel.com</a>.</p>
          </section>
        </div>
      </main>
    </div>
