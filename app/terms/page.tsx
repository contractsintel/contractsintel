        ...
        <div className="space-y-8 text-[15px] text-[#4b5563] leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>All plans include a <strong className="text-[#111827]">14-day free trial</strong>. No credit card is required to start the trial. A payment method is required by Day 7 to continue the trial.</li>
              <li>Subscriptions are <strong className="text-[#111827]">month-to-month</strong> with no long-term commitment. You may cancel at any time.</li>
              ...
              <li>We reserve the right to modify pricing with <strong className="text-[#111827]">30 days written notice</strong> to active subscribers. Price changes do not affect the current billing period.</li>
