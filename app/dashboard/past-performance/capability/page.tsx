...
import { AgencyPicker, NaicsPicker } from "../../typeahead";
          ...
          {retargetOpen && (
            <div className="mt-3 space-y-3">
              <div>
                ...
                <AgencyPicker value={retargetAgency} onChange={setRetargetAgency} />
              </div>
              <div>
                <label className="block text-xs text-[#64748b] mb-1">Target NAICS</label>
                <NaicsPicker value={retargetOpportunity} onChange={setRetargetOpportunity} />
              </div>
              <div>
