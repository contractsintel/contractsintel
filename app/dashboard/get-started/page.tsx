      ...
      <div className="border border-[#e5e7eb] bg-[#f8f9fb] p-4 space-y-2">
        ...
        {[
          ...
          <div key={i} className="flex items-center gap-3 py-1">
            ...
            <span className="text-xs text-[#64748b] flex-1 truncate">{item.title}</span>
            <span className="text-xs font-mono text-[#0f172a]">{item.val}</span>
          </div>
        ))}
        <div className="text-[10px] text-[#94a3b8] pt-1">+ 4 more matches</div>
      </div>
    </div>
  );
}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-sm text-[#0f172a]">IT Support Services — Fort Belvoir, VA</span>
              <span className="px-2 py-0.5 text-[10px] font-mono bg-[#22c55e]/10 text-[#22c55e] border border-[#22c55e]/20 uppercase">
                bid
              </span>
            </div>
            <div className="text-xs text-[#64748b] mb-2">Department of Defense | DEMO-2026-0001</div>
  ...
  return (
    <div className="border border-[#e5e7eb] bg-white p-4 my-4">
      ...
      <div className="flex items-center gap-2 bg-[#f8f9fb] border border-[#e5e7eb] p-4">
        ...
        <div className="px-3 py-1.5 text-xs text-[#94a3b8]">Skip</div>
  ...
  return (
    <div className="border border-[#e5e7eb] bg-white p-4 my-4">
      ...
      <div className="flex items-center gap-2 bg-[#f8f9fb] border border-[#e5e7eb] p-3">
        <div className="px-2 py-1 text-[10px] border border-[#e5e7eb] text-[#64748b] bg-white">
          All Set-Asides &#x25BC;
        </div>
        <div className="px-2 py-1 text-[10px] border border-[#e5e7eb] text-[#64748b] bg-white">
          Filter agency...
      ...
      <div className="flex gap-2">
        {[
          ...
          <div key={col.label} className="flex-1 bg-[#f8f9fb] border border-[#e5e7eb] p-2">
            <div className="text-[9px] font-mono text-[#94a3b8] uppercase mb-2">
              {col.label} ({col.count})
            </div>
            {col.items.map((item, i) => (
              <div key={i} className="bg-white border border-[#e5e7eb] p-1.5 mb-1 text-[9px] text-[#64748b] truncate">
                {item}
              </div>
            ))}
          </div>
      ...
      <div className="bg-[#f8f9fb] border border-[#e5e7eb] p-4 space-y-1.5">
        {[
          ...
          <div key={i} className={`flex items-center gap-3 border-l-2 ${item.color} pl-2 py-1`}>
            <span className="text-[10px] font-mono text-[#94a3b8] w-10">{item.date}</span>
    ...
    <div className="border border-[#e5e7eb] bg-white p-4 my-4">
      ...
      <div className="bg-[#f8f9fb] border border-[#e5e7eb] p-4">
        <div className="flex gap-1 mb-3">
          ...
          <div className="px-2 py-1 text-[9px] border border-[#e5e7eb] text-[#94a3b8]">Past Performance</div>
          <div className="px-2 py-1 text-[9px] border border-[#e5e7eb] text-[#94a3b8]">Executive Summary</div>
        </div>
...
function MockPastPerformance() {
  return (
    <div className="border border-[#e5e7eb] bg-white p-4 my-4">
      ...
      <div className="bg-[#f8f9fb] border border-[#e5e7eb] p-4">
        <div className="text-xs text-[#0f172a] mb-2">VA IT Support Contract</div>
        <div className="text-[10px] text-[#94a3b8] mb-3">DEMO-VA-2025-001 | $320,000</div>
    ...
    <div className="border border-[#e5e7eb] bg-white p-4 my-4">
      ...
      <div className="bg-[#f8f9fb] border border-[#e5e7eb] p-4">
        {["Quality", "Schedule", "Cost Control", "Management"].map((cat, i) => (
          <div key={i} className="flex items-center justify-between py-1 text-[10px]">
            <span className="text-[#64748b]">{cat}</span>
      ...
      <div className="bg-[#f8f9fb] border border-[#e5e7eb] p-4 space-y-2">
        {[
          ...
          <div key={i} className="flex items-center justify-between text-[10px]">
            <div>
              <span className="text-[#0f172a]">{item.prime}</span>
              <span className="text-[#94a3b8] mx-2">|</span>
              <span className="text-[#64748b]">{item.need}</span>
            </div>
            <span className="font-mono text-[#94a3b8]">{item.naics}</span>
          </div>
        ))}
      </div>
    </div>
...
function MockCompetitors() {
  return (
    <div className="border border-[#e5e7eb] bg-white p-4 my-4">
      ...
      <div className="bg-[#f8f9fb] border border-[#e5e7eb] p-4">
        <div className="text-xs text-[#0f172a] mb-2">Apex Systems Inc.</div>
    ...
    <div className="border border-[#e5e7eb] bg-white p-4 my-4">
      ...
      <div className="bg-[#f8f9fb] border border-[#e5e7eb] p-4">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-xs text-[#0f172a]">GSA Schedule 70</span>
        </div>
...
<p className="text-sm text-[#64748b] mt-1">
      ...
      <div className="mb-6">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-[#0f172a]">{completedCount} of {totalItems} complete</span>
            <span className="text-sm text-[#64748b]">{progressPct}%</span>
          </div>
          ...
          {items.map((item, idx) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-[15px] text-[#0f172a]">{item.label}</p>
                <p className="text-sm text-[#64748b] mt-0.5">{item.detail}</p>
              </div>
              ...
              {item.done ? (
                ...
                <span className="shrink-0 px-3 py-1 text-xs font-medium rounded border border-[#e5e7eb] text-[#94a3b8]">
                  Pending
                </span>
              )}
            </div>
      ...
      <div className="border border-[#e5e7eb] bg-white p-6 mb-6">
        <h2 className="text-xs font-medium uppercase tracking-wide text-[#94a3b8] mb-2">Quick Start Guide</h2>
        <p className="text-sm text-[#64748b]">Written guides for every product, grouped by tier. Each explains what it does, why it matters, and how to use it step by step.</p>
      </div>
            ...
            <div key={catKey} className="border border-[#e5e7eb] rounded-lg overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  <h3 className="text-base font-bold text-[#0f172a]">{category.label}</h3>
                  {category.badge && (
                    <span className={`px-2 py-0.5 text-[10px] font-mono uppercase border rounded ${category.badgeColor}`}>{category.badge}</span>
                  )}
                  <span className="text-xs text-[#94a3b8]">({category.guides.length})</span>
                </div>
                <svg className={`w-4 h-4 text-[#94a3b8] transition-transform duration-200 ${isCatOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" d="M19 9l-7 7-7-7" /></svg>
              </button>
                      ...
                      <div key={guide.id}>
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <h4 className="text-sm font-medium text-[#0f172a]">{guide.title}</h4>
                          </div>
                          <svg className={`w-3.5 h-3.5 text-[#94a3b8] transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" d="M19 9l-7 7-7-7" /></svg>
                        </button>
                        {isOpen && (
                          <div className="px-5 pl-16 pb-5 pt-1">
                            <div className="space-y-5">
                              <div>
                                <h5 className="text-xs font-medium uppercase tracking-wide text-[#94a3b8] mb-1.5">What it does</h5>
                                <p className="text-sm text-[#64748b] leading-relaxed">{guide.whatItDoes}</p>
                              </div>
                              <div>
                                <h5 className="text-xs font-medium uppercase tracking-wide text-[#94a3b8] mb-1.5">Why it matters</h5>
                                <p className="text-sm text-[#64748b] leading-relaxed">{guide.whyItMatters}</p>
                              </div>
                              <div>
                                <h5 className="text-xs font-medium uppercase tracking-wide text-[#94a3b8] mb-1.5">How to use it</h5>
                              ...
                              <div>
                                <h5 className="text-xs font-medium uppercase tracking-wide text-[#94a3b8] mb-1.5">Tips</h5>
                                <p className="text-sm text-[#64748b] leading-relaxed">{guide.tips}</p>
                              </div>
                            </div>
                          </div>
                        )}
