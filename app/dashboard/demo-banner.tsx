...
export function DemoBanner() {
  ...
  return (
    <div className="border border-[#e5e7eb] bg-[#eff4ff] px-5 py-3 mb-6 rounded-xl flex items-center justify-between">
      ...
      <button
        onClick={handleClear}
        disabled={clearing}
        className="text-xs text-[#3b82f6] hover:text-[#0f172a] transition-colors shrink-0 ml-4"
      >
