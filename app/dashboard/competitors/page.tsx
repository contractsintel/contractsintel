        ...
        <div className="border border-[#1e2535] bg-white p-5 rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.04)] mb-6">
          <form onSubmit={handleAdd} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs text-[#8b9ab5] mb-1 font-medium uppercase tracking-wide">Company Name</label>
                <input
                  type="text"
                  value={form.name}
              ...
              <div>
                <label className="block text-xs text-[#8b9ab5] mb-1 font-medium uppercase tracking-wide">UEI (optional)</label>
                <input
                  type="text"
                  value={form.uei}
            ...
            <div>
              <label className="block text-xs text-[#8b9ab5] mb-1 font-medium uppercase tracking-wide">Notes</label>
              <textarea
                value={form.notes}
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {competitors.map((comp) => {
            ...
            return (
              <div key={comp.id} className="border border-[#1e2535] bg-white">
                ...
                {encounters.length > 0 && (() => {
                  ...
                  return (
                    <div className="p-5">
                      <h4 className="text-[10px] font-medium uppercase tracking-wide text-[#4a5a75] mb-3">Encounters</h4>
