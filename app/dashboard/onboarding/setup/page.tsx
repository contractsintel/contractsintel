          ...
          <div>
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="text-[14px] text-[#c5cde0]">Only show contracts with set-asides matching my certifications</span>
              </label>
              <label className="flex items-center gap-3 cursor-pointer">
                <input type="radio" checked={setAsidePref === "all"} onChange={() => setSetAsidePref("all")} className="w-4 h-4 text-[#4f46e5]" />
                <span className="text-[14px] text-[#c5cde0]">Show all contracts (including full &amp; open competition)</span>
              </label>
            </div>
          </div>
