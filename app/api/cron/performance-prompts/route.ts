      ...
      const html = `
        <div style="background:#080a0f;padding:32px;font-family:system-ui,-apple-system,sans-serif;">
          <div style="max-width:560px;margin:0 auto;">
            <h1 style="color:#e8edf8;font-size:18px;margin-bottom:4px;">Monthly Performance Log Reminder</h1>
            <p style="color:#8b9ab5;font-size:14px;margin-bottom:24px;">${orgName}</p>
            <div style="background:#0d1018;border:1px solid #1e2535;padding:16px;margin-bottom:16px;">
              <p style="color:#4a5a75;font-size:10px;text-transform:uppercase;letter-spacing:0.05em;margin:0 0 4px 0;">Contract</p>
              <p style="color:#e8edf8;font-size:14px;margin:0 0 12px 0;">${record.contract_title}</p>
              <p style="color:#4a5a75;font-size:10px;text-transform:uppercase;letter-spacing:0.05em;margin:0 0 4px 0;">Agency</p>
              <p style="color:#e8edf8;font-size:14px;margin:0 0 12px 0;">${record.agency}</p>
              <p style="color:#4a5a75;font-size:10px;text-transform:uppercase;letter-spacing:0.05em;margin:0 0 4px 0;">Missing Log For</p>
              <p style="color:#f59e0b;font-size:14px;margin:0;">${monthLabel}</p>
            </div>
            <p style="color:#8b9ab5;font-size:13px;margin-bottom:16px;">
