    ...
    <div className="min-h-screen bg-[#080a0f] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="border border-[#1e2535] bg-[#0d1018] p-8">
          <h1 className="text-2xl font-semibold text-[#e8edf8] mb-2">Sign in</h1>
          ...
          <p className="text-center text-sm text-[#8b9ab5] mt-6">
            No account? <Link href="/signup" className="text-[#3b82f6] hover:text-[#e8edf8]">Start free trial</Link>
          </p>
        </div>
      </div>
    </div>
