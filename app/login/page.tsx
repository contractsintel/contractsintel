    ...
    <div className="min-h-screen bg-[#f8f9fb] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="border border-[#e5e7eb] bg-white p-8 rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)]">
          ...
          <p className="text-[#64748b] text-sm mb-6">Access your contract intelligence dashboard</p>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-[#ffffff] px-3 text-[#94a3b8]">or</span></div>
          </div>

          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="block text-xs text-[#64748b] mb-1.5 font-mono uppercase tracking-wider">Email</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-xs text-[#64748b] mb-1.5 font-mono uppercase tracking-wider">Password</label>
              <input
                type="password"
                value={password}
