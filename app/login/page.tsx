  ...
  return (
    <div className="min-h-screen bg-[#080a0f] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="border border-[#1e2535] bg-white p-8 rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.04),0_1px_2px_rgba(0,0,0,0.02)]">
          <h1 className="font-['DM_Serif_Display'] text-[28px] text-[#0f172a] mb-2">Sign in</h1>
          <p className="text-[#8b9ab5] text-sm mb-6">Access your contract intelligence dashboard</p>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-[#0d1018] px-3 text-[#4a5a75]">or</span></div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-white border border-[#2a3548] rounded-lg text-[#e8edf8] px-4 py-3 text-sm focus:outline-none focus:border-[#2563eb] focus:ring-2 focus:ring-[#2563eb]/10"
                required
              />
            </div>
            <div>
