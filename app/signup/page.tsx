  ...
  return (
    <div className="min-h-screen bg-[#f8f9fb] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="border border-[#e5e7eb] bg-white p-8 rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white px-3 text-[#9ca3af]">or sign up with email</span></div>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              <label className="block text-xs text-[#4b5563] mb-1.5 font-mono uppercase tracking-wider">
                UEI <span className="text-[#9ca3af]">(optional)</span>
              </label>
              <input
                type="text"
                value={uei}
