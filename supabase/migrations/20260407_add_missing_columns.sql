...
ALTER TABLE opportunity_matches ADD COLUMN IF NOT EXISTS user_notes TEXT DEFAULT NULL;
ALTER TABLE opportunity_matches ADD COLUMN IF NOT EXISTS notes_updated_at TIMESTAMPTZ DEFAULT NULL;
